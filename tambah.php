...
<section>
    <div class="container">
        <div class="row mt-5 text-center">
            <div class="col-12">
                <h1 class="text-dark fw-bolder" >Tambah Data Barang</h1>
            </div>
        </div>
        <div class="row mt-2 d-flex justify-content-center">
            ...
            <div class="mb-3">
                 ...
                 <input type="number" name="stok_barang" class="form-control" id="stokbarang" placeholder="Masukan stok barang" required>
            </div>  
